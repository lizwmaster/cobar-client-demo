...
public class UserQuery extends BaseQuery {
	...
	private static final long serialVersionUID = 6509125478591717389L;
	/**
	...
	public UserQuery setTaobaoId(Long taobaoId) {
	...
	public UserQuery setNameLike(boolean nameLike) {
	 ...
	 *            是否升序，否则为降序
	 */
	public UserQuery orderbyTaobaoId(boolean isAsc) {
	 ...
	 *            是否升序，否则为降序
	 */
	public UserQuery orderbyName(boolean isAsc) {
	 ...
	 *            是否升序，否则为降序
	 */
	public UserQuery orderbyUpdTime(boolean isAsc) {
